    ...
    <nav className="fixed w-full z-10 bg-white/10 shadow-md">
      <div className="max-w-screen-xl mx-auto px-4 py-4 flex items-center justify-between">
        <a href="/" className="flex items-center space-x-3">
          <img src="/Tecnologia-para-todos.svg" alt="Logo de Tecnologia para todos" className="h-20" />
        </a>
        ...
        <div className={`${isOpen ? 'block' : 'hidden'} w-full md:flex md:items-center md:space-x-3 md:justify-end`}>
